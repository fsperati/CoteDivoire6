...
lyr_Centredesant_5.set('fieldAliases', {'amenity': 'amenity', 'speciality': 'speciality', 'operator': 'operator', 'contact': 'contact', 'source': 'source', 'addr_city': 'addr_city', 'name': 'name', 'changese_3': 'changese_3', 'operator_t': 'operator_t', });
...
lyr_Centredesant_5.set('fieldImages', {'amenity': 'TextEdit', 'speciality': 'TextEdit', 'operator': 'TextEdit', 'contact': 'TextEdit', 'source': 'TextEdit', 'addr_city': 'TextEdit', 'name': 'TextEdit', 'changese_3': 'TextEdit', 'operator_t': 'TextEdit', });
...
lyr_Centredesant_5.set('fieldLabels', {'amenity': 'inline label', 'speciality': 'inline label', 'operator': 'inline label', 'contact': 'inline label', 'source': 'inline label', 'addr_city': 'inline label', 'name': 'inline label', 'changese_3': 'inline label', 'operator_t': 'inline label', });
