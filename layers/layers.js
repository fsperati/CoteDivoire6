...
lyr_Centredesant_5.set('fieldAliases', {'amenity': 'amenity', 'name': 'name', 'changese_3': 'changese_3', });
...
lyr_Centredesant_5.set('fieldImages', {'amenity': 'TextEdit', 'name': 'TextEdit', 'changese_3': 'TextEdit', });
...
lyr_Centredesant_5.set('fieldLabels', {'amenity': 'inline label', 'name': 'inline label', 'changese_3': 'inline label', });
